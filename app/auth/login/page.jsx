...
const LoginPage = () => {
  return (
    <>
      ...
      <body className="bg-[url(/imgs/bg-mobile.jpg)] md:bg-[url(/imgs/bg-desktop.jpg)] text-gray-200 font-sans flex justify-center items-center h-screen text-center overflow-hidden">
