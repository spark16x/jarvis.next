...
const LoginPage = () => {
  return (
    <>
      ...
      <body style="background:url(/imgs/bg-desktop.jpg) " className=" bg-[url(/imgs/bg-desktop.jpg)] text-gray-200 font-sans flex justify-center items-center h-screen text-center overflow-hidden">
